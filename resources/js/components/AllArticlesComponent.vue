<template>
    <div class="art-list">
        <div class="px-4 py-5 my-5 text-left" v-for="item in all.data" :key="item.id">
            <img class="d-block mx-auto mb-4" :src="item.image" alt="">
            <a :href="/articles/ + item.id"><h1 class="display-5 fw-bold">{{ item.title }}</h1></a>
